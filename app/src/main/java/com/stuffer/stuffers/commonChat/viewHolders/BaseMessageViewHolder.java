...
import static com.stuffer.stuffers.commonChat.chatAdapters.MessageAdapter.OTHER;
...
import com.stuffer.stuffers.commonChat.chatUtils.GeneralUtils;
...
public class BaseMessageViewHolder extends RecyclerView.ViewHolder {
    ...
    public void setData(Message message, int position) {
        ...
        if (!message.getChatId().startsWith(ChatHelper.GROUP_PREFIX) || message.getAttachmentType() == AttachmentTypes.NONE_NOTIFICATION) {
