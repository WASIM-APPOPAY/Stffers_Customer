...
public class Chat implements Parcelable {
    private String chatChild, userId, dateTimeStamp, timeDiff, lastMessage, chatName, chatImage, lastMessageId;
    @Exclude
    ...
    public Chat(User user, String myId) {
        this.chatChild = ChatHelper.getChatChild(user.getId(), myId);
    ...
    public String getTimeDiff() {
        this.timeDiff = ChatHelper.timeDiff(Long.valueOf(this.dateTimeStamp)).toString();
        return timeDiff;
    }
    ...
    public boolean isGroup() {
        return getChatChild().startsWith(ChatHelper.GROUP_PREFIX);
    }
