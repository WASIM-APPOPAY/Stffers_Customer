...
public class DownloadUtil {
    ...
    public void checkAndLoad(Context context, DownloadFileEvent downloadFileEvent) {
        ...
        File file = new File(ChatHelper.getFileBase(context) + "/"
                +
        ...
        if (file.exists()) {
            ...
            newIntent.setDataAndType(FileProvider.getUriForFile(context, "com.stuffrs.merchant.fileprovider", file), ChatHelper.getMimeType(context, Uri.fromFile(file)));
