...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.ViewHolder> {
    ...
    public UserAdapter(Context mContext, List<ChatUser> mUsers, boolean ischat) {
        this.mUsers = mUsers;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (user.getImageURL().equals("default")) {
            ...
            //no need to set image we have default one
        } else {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(AppoConstants.USERID, user.getId());
                //intent.putExtra(AppoConstants.MOBILENUMBER,user.getPhone_number());
                intent.putExtra(AppoConstants.USERNAME, user.getUsername().toUpperCase());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private CircleImageView image_on, image_off;
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ...
                    if (Objects.requireNonNull(chat).getReceiver().equals(Objects.requireNonNull(firebaseUser).getUid()) && chat.getSender().equals(user_id) ||
                ...
                switch (theLastMessage) {
                    ...
                    default:
                        if (theLastMessage.contains("/images")) {
                            last_msg.setText("share photo");
                        } else {
