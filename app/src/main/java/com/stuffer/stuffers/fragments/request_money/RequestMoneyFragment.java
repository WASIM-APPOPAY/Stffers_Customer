...
public class RequestMoneyFragment extends Fragment {
    private static final String TAG = "RequestMoneyFragment";
    MyButton btnSearch;
    ...
    private String recivername, reciveruserid;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View mView = inflater.inflate(R.layout.fragment_request_money, container, false);
    ...
    private void getConversionBaseRate(int pos) {
        ...
        AndroidNetworking.get(url)
                .setOkHttpClient(Appo.getOkHttpClient(10))
