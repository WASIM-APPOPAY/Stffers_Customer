package com.stuffer.stuffers.activity.mall;
...
import com.stuffer.stuffers.adapter.mall.GridviewAdapter;
import com.stuffer.stuffers.adapter.mall.ProductRatingListViewAdapter;
...
import com.stuffer.stuffers.events.Events;
import com.stuffer.stuffers.events.GlobalBus;
import com.stuffer.stuffers.fragments.mall.ImageSlideShowDialogFragment;
...
public class ProductDetailActivity extends AppCompatActivity {
    ...
    public void onResume() {
        ...
        if (AppoPayApplication.isNetworkAvailable(ProductDetailActivity.this)) {
...
//                            mImageSlider.setCurrentPosition(-1);
                       ...
                       // getSimilarProductsFromChildCat();
                        ...
                        txtNewPrice.setText(AppoPayApplication.CURRENCY_SYMBOL + newPrice);
                        txtOldPrice.setText(AppoPayApplication.CURRENCY_SYMBOL + oldPrice);
...
//            Toast.makeText(ProductDetailActivity.this, "Product Added To Cart", Toast.LENGTH_SHORT).show();
    ...
    class GetAlreadyAddedProductPrice extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            //adding to database
            alreadyAddedProductPrice = DatabaseClient.getInstance(AppoPayApplication.getInstance()).getAppDatabase()
                    .daoProduct()
