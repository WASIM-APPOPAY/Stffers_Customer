...
import com.stuffer.stuffers.adapter.wallet.WalletTransactionAdapter;
...
import static com.stuffer.stuffers.utils.DataVaultManager.KEY_WALLET_ID;
...
public class PaymentsActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        currencyname.setText(AppoPayApplication.CURRENCY_CODE);
    ...
    private void getAllTransactionsRequest() {
        ...
        String wallet_id = DataVaultManager.getInstance(AppoPayApplication.getInstance()).getVaultValue(KEY_WALLET_ID);
                ...
                if (response.isSuccessful()) {
                    ...
                    if (response.body().getSuccess().equalsIgnoreCase("1")) {
                        ...
                        if (transactionArrayList.isEmpty()) {
                            ...
                            accountBalance.setText(AppoPayApplication.CURRENCY_SYMBOL + strAccountBalance);
