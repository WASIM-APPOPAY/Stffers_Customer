...
public class E_StoreDiscountActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_estore_discount);
        mainAPIInterface = ApiUtils.getAPIService();

        findViewById(R.id.search_back).setOnClickListener(view -> E_StoreDiscountActivity.this.onBackPressed());
        ...
        url = "http://18.220.143.66:82/h5/#/appopayguide?areacode="+ Helper.getSenderAreaCode()+"&"+"phonenumber="+Helper.getSenderMobileNumber()+"&usertype=CUSTOMER";
