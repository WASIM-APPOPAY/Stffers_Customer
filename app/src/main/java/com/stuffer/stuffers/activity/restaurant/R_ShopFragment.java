...
public class R_ShopFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View mView = inflater.inflate(R.layout.fragment_r__shop, container, false);
    ...
    private void getItems() {
        ...
        apiServiceShop.getRestaurentAllItemsShop(String.valueOf(mPage), String.valueOf(10)).enqueue(new Callback<RestaurentModels>() {
            @Override
