...
public class UnionVisaFragment extends Fragment implements View.OnClickListener {
    private View mView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView = inflater.inflate(R.layout.fragment_union_visa, container, false);
