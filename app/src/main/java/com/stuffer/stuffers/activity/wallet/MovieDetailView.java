...
import com.stuffer.stuffers.fragments.movies.MovieDetailFragment;
import com.stuffer.stuffers.fragments.movies.TheatersFragment;
...
public class MovieDetailView extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new TheatersFragment(), getString(R.string.info_show_times));
        adapter.addFragment(new MovieDetailFragment(), getString(R.string.info_about_movies));
