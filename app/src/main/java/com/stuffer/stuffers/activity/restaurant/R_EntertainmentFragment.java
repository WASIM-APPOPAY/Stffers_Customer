...
public class R_EntertainmentFragment extends Fragment {
    ...
    public R_EntertainmentFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View mView = inflater.inflate(R.layout.fragment_r__entertainment, container, false);
    ...
    private void getItems() {
        ...
        apiServiceShop.getRestaurentAllItemsEntertainment(String.valueOf(mPage), String.valueOf(10)).enqueue(new Callback<RestaurentModels>() {
            @Override
