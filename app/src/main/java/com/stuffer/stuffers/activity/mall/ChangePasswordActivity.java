...
public class ChangePasswordActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (AppoPayApplication.isNetworkAvailable(ChangePasswordActivity.this)) {
    ...
    private void sendPasswordOTP() {
        ...
        String strUserEmail = DataVaultManager.getInstance(AppoPayApplication.getInstance()).getVaultValue(KEY_EMAIL);
    ...
    private void changePasswordRequest() {
        ...
        strUserId = DataVaultManager.getInstance(AppoPayApplication.getInstance()).getVaultValue(KEY_USER_ID);
