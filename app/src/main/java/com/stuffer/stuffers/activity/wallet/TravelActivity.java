...
public class TravelActivity extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new FragmentTrain(), getString(R.string.info_train));
        adapter.addFragment(new FragmentFlight(), getString(R.string.info_flights));
        adapter.addFragment(new FragmentBus(), getString(R.string.info_bus));
    ...
    private void setupActionBar() {
        ...
        toolbarTitle.setText(R.string.appopay_travel);
