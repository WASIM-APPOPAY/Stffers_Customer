...
public class VisaUnionFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView = inflater.inflate(R.layout.fragment_visa_union, container, false);
    ...
    private void showSuccessDialog() {
        ...
        View dialogLayout = inflater.inflate(R.layout.dialog_success_unionvisa, null);
