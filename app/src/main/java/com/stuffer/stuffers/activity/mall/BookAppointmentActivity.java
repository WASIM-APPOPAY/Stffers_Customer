...
public class BookAppointmentActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
      ...
      /*  if (AppoPayApplication.PAYPAL_SANDBOX.equalsIgnoreCase("1")) {
        ...
        serviceFees.setText(AppoPayApplication.CURRENCY_SYMBOL + strPrice);
   ...
   /* private void paymentRequestForBooking() {
        ...
        Double strPrice1 = Double.valueOf(strPrice) / Double.valueOf(AppoPayApplication.CURRENCY_EXCHANGE_RATE);
   ...
   /* @Override
    ...
    private void confirmBookingRequest() {
        ...
        strCustomerId = DataVaultManager.getInstance(AppoPayApplication.getInstance()).getVaultValue(KEY_USER_ID);
        strCustomerName = DataVaultManager.getInstance(AppoPayApplication.getInstance()).getVaultValue(KEY_NAME);
        strCustomerEmail = DataVaultManager.getInstance(AppoPayApplication.getInstance()).getVaultValue(KEY_EMAIL);
