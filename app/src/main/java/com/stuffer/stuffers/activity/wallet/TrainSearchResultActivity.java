...
import com.stuffer.stuffers.adapter.travel.TrainListAdapter;
import com.stuffer.stuffers.models.output.TrainSearchResult;
...
public class TrainSearchResultActivity extends AppCompatActivity {
    ...
    private void setupActionBar() {
        ...
        toolbarTitle.setText(R.string.info_delhi_to_mum);
