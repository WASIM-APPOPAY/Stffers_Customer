...
public class CartListAdapter extends RecyclerView.Adapter<CartListAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.txtProductPrice.setText("Price : " + AppoPayApplication.CURRENCY_SYMBOL + product.getPrice());
...
//            deliveryResponseList.clear();
    ...
    class GetAlreadyAddedProductCount extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            count = DatabaseClient.getInstance(AppoPayApplication.getInstance()).getAppDatabase()
                    .daoProduct()
...
//            viewHolder.txtProductQuantity.setText(String.valueOf(alreadyAddedProductCount));
    ...
    class GetAlreadyAddedProductPrice extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            viewHolder.txtProductPrice.setText("Price : " + AppoPayApplication.CURRENCY_SYMBOL + alreadyAddedProductPrice);
    ...
    class UpdateProductCount extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            //adding to database
            DatabaseClient.getInstance(AppoPayApplication.getInstance()).getAppDatabase()
                    .daoProduct()
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            Toast.makeText(AppoPayApplication.getInstance(), "Product count==" + newValue, Toast.LENGTH_SHORT).show();
    ...
    class UpdateProductPrice extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            Toast.makeText(AppoPayApplication.getInstance(), "Product count==" + alreadyAddedProductCount, Toast.LENGTH_SHORT).show();
